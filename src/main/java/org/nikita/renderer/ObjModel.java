...
public class ObjModel {
    ...
    public ObjModel(String source, Color color, Vector lightSourcePosition, double ambientLightIntensity)
            throws IOException {
        this.color = color;

        triangles = new HashSet<>();
        triangleColorIntensitySolver =
                new NormalTriangleColorIntensitySolver(ambientLightIntensity, lightSourcePosition);

        populateTriangles(source);
        buildTree();
    }
    ...
    private void populateTriangles(String source) throws IOException {
